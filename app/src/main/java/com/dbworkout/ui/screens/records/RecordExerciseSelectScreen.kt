...
@Composable
fun RecordExerciseSelectScreen(
    ...
    Scaffold(
        topBar = {
            TopAppBar(
                title = { Text(stringResource(R.string.choose_exercise_for_record), fontWeight = FontWeight.SemiBold) },
                navigationIcon = {
        ...
        Column(Modifier.fillMaxSize().padding(padding)) {
            OutlinedTextField(
                ...
                modifier = Modifier.fillMaxWidth().padding(horizontal = 16.dp, vertical = 8.dp).testTag("record_exercise_search"),
